...
function RemoveBridgeLiquidityMum() {
    ...
    async function getBalancesAndFees(token){
        ...
        if (walletAddress)
        {
        const contract=await getMumBridgeContract()
        ...
        let TokenContract = await getMUMTokenContract(token);
    ...
    async function CollectFee(token){
        try{
        const contract=await getContract(bridgeABI,mumBridgeAddress)
        await shiftChain(80001)
    ...
    useEffect(()=>{
        getBalancesAndFees("0x900d7F81B9cA80083223e36b09C30a7E4bBFaAdA")
    ...
    <div class="container" style={{ marginTop:'7rem'}}>
{
    ...
    <div className="d-flex justify-content-center align-items-center py-5">
      ...
      <div class="card text-center shadow-lg col-md-6 col-lg-6 rounded-0 border border-end-0 border-start-0 border-top-0 border-3 border-primary">
        ...
        {
            fee>0 ?
            <button onClick={()=>{CollectFee("0x900d7F81B9cA80083223e36b09C30a7E4bBFaAdA")}} type="button" className="btn btn-primary btn-lg rounded-pill w-100">Collect Fee</button>
         :
         <button disabled onClick={()=>{CollectFee("0x900d7F81B9cA80083223e36b09C30a7E4bBFaAdA")}} type="button" className="btn btn-primary btn-lg rounded-pill w-100">Collect Fee</button>
          ...
          <div className='container my-3'>
            {
                UsersReserves>0?
                <button onClick={()=>{RemoveLiquidity("0x900d7F81B9cA80083223e36b09C30a7E4bBFaAdA")}} type="button" className="btn btn-primary btn-lg rounded-pill w-100">Get Liquidity</button>
          :
          <button disabled onClick={()=>{RemoveLiquidity("0x900d7F81B9cA80083223e36b09C30a7E4bBFaAdA")}} type="button" className="btn btn-primary btn-lg rounded-pill w-100">Get Liquidity</button>
          ...
          {/* <div className='container my-3'>
        {
            ...
            <button onClick={()=>{WithdrawOnSecondBlockchain(0x13881,"0x900d7F81B9cA80083223e36b09C30a7E4bBFaAdA",supply,(Number(ActualFee)+Number(ActualReserves)))}} type="button" className="btn btn-primary btn-lg rounded-pill w-100">Withdraw on second blockchain</button>
